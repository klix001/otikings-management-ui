...
export default function BarManagement() {
  ...
  return (
    <div className="max-w-7xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-neutral-900 mb-2">Bar Department</h1>
        <p className="text-neutral-600">Comprehensive view of all bar operations</p>
      </div>
      ...
      <div className="mt-4">
        {activeTab === 'overview' && <BarAnalytics hideHeader />}
        {activeTab === 'inventory' && <Inventory isSuperAdmin={isSuperAdmin} />}
        {activeTab === 'suppliers' && <Suppliers department="bar" />}
